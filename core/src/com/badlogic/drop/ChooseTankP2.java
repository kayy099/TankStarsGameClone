...
public class ChooseTankP2 implements Screen {
    ...
    public ChooseTankP2(final TankStars game) {
        this.game = game;
        skin = new Skin(Gdx.files.internal("star-soldier/skin/star-soldier-ui.json"));
        camera = new OrthographicCamera(Gdx.graphics.getWidth(), Gdx.graphics.getHeight());
        stage = new Stage();
        backgroundImage = new Texture(Gdx.files.internal("tank_stars_tank2_bg.png"));
    ...
    public void show() {
        ...
        back = new TextButton("Back to Previous Page", skin);
